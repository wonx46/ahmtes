...
//		}
		...
		public DtoResponse getBrandbycode(@RequestBody AhmsdnisMstbrndId obj){
			List<AhmsdnisMstbrnd> list = new ArrayList<AhmsdnisMstbrnd>();
			AhmsdnisMstbrnd brand = com001Service.getBrand(obj);
			list.add(brand);
			 return DtoHelper.constructResponse(StatusMsgEnum.SUKSES, null, list);
		}
		
//		@RequestMapping(value="/delete/{id}", method = RequestMethod.GET)
//		public DtoResponse deletePath(@PathVariable String id){
//			
//			try {
...
//		}
		...
		public DtoResponse delete(@RequestBody AhmsdnisMstbrndId obj){
			
			try {
				com001Service.deleteBrand(obj);
				 return DtoHelper.constructResponse(StatusMsgEnum.SUKSES, null, null);
			} catch (Exception e) {
				e.printStackTrace();
				 return DtoHelper.constructResponse(StatusMsgEnum.GAGAL, null, null);
...
//			System.out.println(obj.getVbrndcd()+" - "+obj.getVbrndnm());
			try {
				AhmsdnisMstbrnd exist  = com001Service.getBrand(obj.getId());
				if(exist != null){
