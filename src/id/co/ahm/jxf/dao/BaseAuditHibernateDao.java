 ...
 * @author achmad.ha
 */
public class BaseAuditHibernateDao<T, K extends Serializable> extends BaseColumnFilterDao implements BaseAuditDao<T, K>{
    ...
    @Override
    public boolean delete(BaseAudit entity) {
        getCurrentSession().delete(entity);
        return true;
    }
    ...
    @Override
    public boolean save(BaseAudit newEntity, String user,String idservice) {
        Date date = new Date();
...
//        newEntity.setLastModDate(date);
    ...
    @Override
    public boolean update(BaseAudit editedEntity, String user,String idservice) {
