 ...
 * @author hendra.fs
 */
public class PortalHibernateDao<T, K extends Serializable> extends BaseColumnFilterDao implements HrDao<T, K> {

    @SuppressWarnings("unchecked")
    protected Class persistentClass;

    @Autowired
    @Qualifier("sessionFactoryPortal")
    protected SessionFactory sessionFactoryPortal;
    ...
    protected Session getCurrentSession() {
        return sessionFactoryPortal.getCurrentSession();
    }
