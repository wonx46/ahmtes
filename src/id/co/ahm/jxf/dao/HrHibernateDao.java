 ...
 * @author achmadha
 */
public class HrHibernateDao <T, K extends Serializable> implements HrDao<T, K> {
    ...
    @Autowired
    @Qualifier("sessionFactoryHr")
    protected SessionFactory sessionFactoryHr;

    @SuppressWarnings("unchecked")
    public HrHibernateDao() {
        persistentClass = (Class<T>) ((ParameterizedType) getClass().getGenericSuperclass()).getActualTypeArguments()[0];
    }

    protected Session getCurrentSession() {
        return sessionFactoryHr.getCurrentSession();
    }
